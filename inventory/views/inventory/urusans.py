...
# List #
########    
@view_config(route_name='inventory-urusan', renderer='templates/urusan/list.pt',
             permission='inventory-urusan')
...
# Action #
##########    
@view_config(route_name='inventory-urusan-act', renderer='json',
             permission='inventory-urusan-act')
...
def route_list(request):
    return HTTPFound(location=request.route_url('inventory-urusan'))
...
@view_config(route_name='inventory-urusan-add', renderer='templates/urusan/add.pt',
             permission='inventory-urusan-add')
    ...
    if request.POST:
        if 'simpan' in request.POST:
            ...
            try:
                ...
                return HTTPFound(location=request.route_url('inventory-urusan-add'))
...
@view_config(route_name='inventory-urusan-edit', renderer='templates/urusan/edit.pt',
             permission='inventory-urusan-edit')
...
# Delete #
##########    
@view_config(route_name='inventory-urusan-delete', renderer='templates/urusan/delete.pt',
             permission='inventory-urusan-delete')
